...
function tabList() {
  return [
    { label: '首页', icon: 'home', url: '/pages/home/home' },
    { label: '待办', icon: 'check-circle', url: '/pages/todo/todo' },
    { label: '任务', icon: 'task', url: '/pages/tasks/tasks' },
    { label: '我的', icon: 'user', url: '/pages/mine/mine' },
  ].map((t, index) => ({ index, ...t }));
}
